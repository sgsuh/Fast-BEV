...
# Include dir (Debian/Ubuntu deb layout keeps the headers under a multiarch dir)
foreach(search ${_TensorRT_SEARCHES})
  find_path(TensorRT_INCLUDE_DIR NAMES NvInfer.h ${${search}}
...
if(NOT TensorRT_LIBRARY)
  foreach(search ${_TensorRT_SEARCHES})
    ...
    find_library(NVOnnxParser NAMES nvonnxparser ${${search}} PATH_SUFFIXES lib lib/x86_64-linux-gnu)
    find_library(NVInferPlugin NAMES nvinfer_plugin ${${search}} PATH_SUFFIXES lib lib/x86_64-linux-gnu)
  endforeach()
endif()
...
if(TensorRT_FOUND)
  ...
  if(NOT TensorRT_LIBRARIES)
    ...
    set(TensorRT_LIBRARIES ${TensorRT_LIBRARY} ${NVOnnxParser} ${NVInferPlugin})
  endif()
